                ...
                <div className="d-flex tw-gap-5 justify-content-between flex-wrap tw-mb-80-px">
                    <div className="max-w-768">
                        ...
                        >
                            <Image
                                ...
                                alt="Image"
                            />
                            <h5 className="fw-normal text-dark-600 cursor-big">
                                Articles
                            </h5>
                        </div>
                        <h2
                    ...
                    <div className="max-w-350">
                        <p
                            ...
                            data-aos-duration={800}
                        >
                            Discover Our Latest Expert Insights, Tips, and
                            Trends on the Blog Today
                        </p>
                        <div
                        ...
                        >
                            ...
                            <div className="tw-px-4 tw-pb-2">
                                ...
                                <h3 className="fw-normal tw-mb-3 text-dark-600 cursor-big">
                                    Analytics-Driven Strategies for Business
                                    Success
                                </h3>
                                <p className="fw-normal tw-text-lg text-dark-500 tw-mb-8">
                                    Discover how data and analytics transform
                                    your business strategies and decision-making
                                    processes.{' '}
                                </p>
                            ...
                            >
                                ...
                                <div className="articles-text max-w-320 tw-px-3 tw-py-5">
                                    ...
                                    <h4 className="fw-normal tw-mb-3 text-dark-600 cursor-big line-clamp-2">
                                        How to Pay Bills Online: A Beginner’s
                                        Guide
                                    </h4>
                                    <p className="fw-normal tw-text-lg text-dark-500 tw-mb-8">
                                        From understanding customer behavior to
