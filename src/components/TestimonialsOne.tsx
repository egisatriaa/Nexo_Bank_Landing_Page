      ...
      <div className='container'>
        ...
        <div className='swiper testimonial-slider one'>
          ...
          >            <div
              ...
              data-aos-duration={600}
            >
              <div className='bg-white tw-p-6 tw-rounded-xl w-100 h-100'>
                <div className=''>
                  <div className='d-flex align-items-center justify-content-between tw-gap-3 flex-wrap tw-mb-4'>
                    ...
                    />
                    <div className=''>
                      <span className='d-block fw-bold text-dark-600 tw-text-base'>
                        Darlene Robertson
                      </span>
                      <span className='fw-normal text-dark-500 tw-text-sm'>
                        Software Tester
                      </span>
                    </div>
                    <Image
                ...
                <p className='fw-normal text-dark-500 tw-text-sm tw-mb-4'>
                ...
                <div className='d-flex align-items-center tw-gap-5 justify-content-between flex-wrap tw-mt-5'>
                  <span className='fw-bold text-dark-600 tw-text-base'>4.5 - Excellent</span>
